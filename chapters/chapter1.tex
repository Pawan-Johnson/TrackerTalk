...
\begin{frame}
    ...
    \begin{figure}
        ...
        \begin{subfigure}{0.49\textwidth}
            ...
            \caption{Clusters from Run \texttt{022300}}
        \end{subfigure}
        \begin{subfigure}{0.49\textwidth}
            % \includegraphics[width=\textwidth]{assets/SpacePoints_Nominal.pdf}
            \caption{Space Points from Run \texttt{022300}}
        \end{subfigure}
        % \includegraphics[height=0.75\textheight]{assets/Clusters_Nominal.pdf}
        \caption{SCT Clusters and Space Points from Run \texttt{022300}. Note that these are subset of the space points that are from the same layer.}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \caption{SCT Hits from Event \texttt{2840829}, Run \texttt{022300}.\\Note that out of time HITS (!\texttt{01X}) are shown in grey.}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \end{tikzpicture}
        \caption{Event \texttt{2840829}, Run {022300}}
    \end{figure}
...
\begin{frame}
    \frametitle{What \blueunderline{could} it mean for the Tracking?}

    \begin{itemize}
        \item It seems one module does not have any data
        \begin{itemize}
            \item This is probably not fully true
        \end{itemize}
        \item In theory this should just be a reduction of two measurements in the final track
        \item The Track-$\chi^2$ is lower for these events, but overall quality ($\chi^2$/NDF) is still good.
        \item  \textcolor{red}{Add chi2 plots to backup}
...
\begin{frame}[fragile]
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Is the raw data actually broken?
...
ToolSvc.TrackerDataDecoderTool            ERROR Online module 0 reports one or more errors.
    ...
    \begin{itemize}
        \item While we report the error, we don't handle it in anyway it just ``continue'' on.
        \item This is the reason we didn't catch it earlier in the prompt reconstruction.
              \begin{itemize}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item But if the track did pass through the module, then we don't use the specific HITs.
        \end{itemize}
    \end{itemize}
...
\begin{frame}[fragile]
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Unless you run in debug mode specifically
        \end{itemize}
    \end{itemize}    
    \scriptsize{
        \begin{verbatim}
[ERROR] (file = TrackerDataFragment.icc)(func = DecodeModuleData)(line = 271) 
    ...
    \begin{itemize}
        \item This is the decoding error that is flagged in the reconstruction.
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \begin{subfigure}{0.49\textwidth}
            ...
            \caption{Space Points from Run \texttt{022300}}
        \end{subfigure}
        % \includegraphics[height=0.75\textheight]{assets/Clusters_Patched.pdf}
        \caption{SCT Clusters and Space Points from Run \texttt{022300} after disabling the error check mentioned above.}
    \end{figure}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \caption{SCT Hits from Event \texttt{2840829}, Run \texttt{022300} after disabling the error check mentioned above.\\Note that out of time HITS (!\texttt{01X}) are shown in grey.}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \end{tikzpicture}
        \caption{Event \texttt{2840829}, Run {022300} after disabling the error check mentioned above.}
    \end{figure}
