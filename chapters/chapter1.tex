    ...
    \begin{itemize}
        ...
        \item In theory this should just be a reduction of two measurements in the final track
              \begin{itemize}
                  ...
                  \item Overlap on fiducial volume is around 5.5\% (See slides from Oscar in backup)
              \end{itemize}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Pick a run (\#{022300}) and count all the strips that were hit
    \end{itemize}
        ...
        \begin{column}{0.5\textwidth}
            \begin{block}{With Error Check Disabled}
                \begin{itemize}
                    ...
                    \item Strips 512 to 639 have no hits (side 1)
...
\begin{frame}
    \frametitle{Fiducial Volume Calculations\hfill \small{[Oscar]}}

    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth, page=4]{assets/Station_2_Issues_Oscar.pdf}
